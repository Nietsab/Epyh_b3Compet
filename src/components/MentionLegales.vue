<template>
    <div class="mention">
    <router-link class="btn" to="/">Retourner au site web</router-link> 
...
<br>
<p>
Ce site web est exploité par Epyh. Sur ce site, les termes "nous", "notre" et "nos" font référence à Epyh. Epyh propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici.
<br>
...
<p> La soumission de vos renseignements personnels sur notre boutique est régie par notre Politique de Confidentialité. Cliquez ici pour consulter notre Politique de Confidentialité.
</p>
<br>
...
<p> Ces Conditions Générales de Vente et d’Utilisation, ainsi que tout autre accord séparé par le biais duquel nous vous fournissons des Services seront régis et interprétés en vertu des lois en vigueur à 8 bis Rue de la Fontaine au Roi, Paris, IDF, 75111, France.
</p>
<br>
...
<p> Les questions concernant les Conditions Générales de Vente et d’Utilisation devraient nous être envoyées à Contact@epyh.fr.</p>
        </div>
    </template>
