<template>
  <div>
<!-- Todo Revoir la newsletter => enlever page de confirmation dans sendinblue si redirection utiliser api -->
    ...
    <footer class="footer">
      <div class="columns">
        <div class="column is-one-quarter contact" style="height: 1%">
          <p>Nous contacter</p><br><br>
          <span>Pour nous joindre par mail : <br>
            <strong style="color: #CC1237"><a href="mailto:contact@epyh.fr">contact@epyh.fr</a></strong>
          </span><br><br><br>
          <span>Retrouvez nous sur les réseaux: <br>
            <a rel="noopener noreferrer" class="rs" href="https://www.instagram.com/epyh2.0/" target="_blank">
              <i class="fab fa-instagram"></i>
            </a>
            <a rel="noopener noreferrer" class="rs" href="https://twitter.com/epyh3" target="_blank">
              <i class="fab fa-twitter"></i>
            </a>
            <a rel="noopener noreferrer"  class="rs" href="https://www.youtube.com/channel/UCpNKwQP_9XiLWwFzYXgwYIQ"
               target="_blank">
              <i class="fab fa-youtube"></i>
            </a>
          </span><br><br>
          <span>Horaires: <br>
            <strong style="color: #CC1237">Lundi au Samedi 10h-19h</strong>
          </span>
        </div>
...
<!--                  src="https://2f9c1cb5.sibforms.com/serve/MUIEAGB1rulXj5J4eu3EtgnXM_OLnivOpLywm5A-B6Baz1aCOwLVgnxo17Wp5u7FaApf2TKmHrly7p9F4jf4-K7traHLgyNLntotesvP4mBK5dpt3WDcEqp72rJy58VEAGJKpgi-kGI0ep58K9VQe1fv2rv1ENf6gShDBYfrL4N2q0qqrvT6aS5gbMtU7vYiGXxYcZ8nf5qUgEnp" frameborder="0" scrolling="auto" allowfullscreen style="display: block;margin-left: auto;margin-right: auto;max-width: 100%;"></iframe>-->
         ...
         background-color: #FAFAFA;;                                           ">
            <div id="sib-form-container" class="sib-form-container">
              ...
              max-width:540px; border-radius:3px; border-width:0px; border-style:solid; background-color: #FAFAFA">
                <form id="sib-form" method="POST"
                      action="https://2f9c1cb5.sibforms.com/serve/MUIEAIkUT7noXQqhmNb7Zl2mgKdpkIRYLrFY2FY00IgaOF6ccLUYXT_idOu0_p3VwHaf2zL4txcFo-bZZbCj9tCM5ENMpO98pPcx3T__FVhQW5g_P3hgvaH-gcBRTHApMbhYsRzRXNkCBId6b9jLj2Ll_6BzLs92sqcQ4nI99T8NCIPTrur-22Z2Av3fcItkOTP09dvYK3MJTWfC" data-type="subscription">
                  <div style="padding: 8px 0;">
                    <div class="sib-form-block" style="font-size:22px; text-align:left; font-family:Poppins; font-weight: 600;
                         font-style: normal;
                          color: #1D1D1D; background-color:transparent">
                      <div class="sib-text-form-block" style="width: 107%;">
                      ...
                      <div class="form__entry entry_block">
                        <div class="form__label-row ">
                          ...
                          <div class="entry__field">
                            <input class="input" maxlength="200" type="text" id="PRENOM" name="PRENOM" autocomplete="off" placeholder="Nom Complet" data-required="true" required />
                          </div>
                        </div>
                        ...
                        <div class="form__label-row ">
                          <div class="entry__choice">
                            <label>
                              ...
                              <span class="checkbox checkbox_tick_positive"></span><span style="font-size:14px;
                              text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#1D1D1D; background-color:transparent;"><p>J'accepte de recevoir vos e-mails</p><span data-required="*" style="display: inline;" class="entry__label entry__label_optin"></span></span> </label>
                          </div>
                        </div>
                        <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;">
                        </label>
                        <label class="entry__specification" style="font-size:11px; text-align:left; font-style:italic; font-family:&quot;Helvetica&quot;, sans-serif; color:#1D1D1D;">
